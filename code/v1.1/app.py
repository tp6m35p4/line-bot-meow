...
seesayList = dict()
channel_secret = 'a413c208e8be80c0a4884e6f5e16bd81'
# 填入你的 message api 資訊
...
def getSeeSay(text):
    ...
    if res:
        ...
        a = []
        a.append(say[1])
        sql = "INSERT INTO `line-bot-meow`.`seesay` (`id`, `see`, `say`, `time`) VALUES (NULL, '{see}', '{say}', CURRENT_TIMESTAMP);".format(see=say[0], say=json.dumps(a, ensure_ascii=False))
